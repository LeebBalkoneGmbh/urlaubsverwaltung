...
class ApplicationMailService {
    ...
    void sendAllowedNotification(Application application, long workDays, ApplicationComment applicationComment) {
        ...
        final MailTemplateModelSupplier modelColleaguesSupplier = _ -> Map.of(APPLICATION, application, "workDays", workDays);
    ...
    void sendEditedNotification(Application application, long workDays, Person editor) {
        ...
        if (application.getPerson().equals(editor)) {
            mailToApplicant = Mail.builder()
                ...
                .withTemplate("application_edited_by_applicant_to_applicant", _ -> Map.of(APPLICATION, application, "workDays", workDays))
            ...
            mailToApplicant = Mail.builder()
                ...
                .withTemplate("application_edited_by_management_to_applicant", _ -> Map.of(APPLICATION, application, "editor", editor, "workDays", workDays))
                .withReplyToFrom(editor)
                .build();
        }
        mailService.send(mailToApplicant);
        ...
        final Mail mailToManagement = Mail.builder()
            ...
            .withTemplate("application_edited_by_applicant_to_management", _ -> Map.of(APPLICATION, application, "editor", editor, "workDays", workDays))
            .withReplyToFrom(editor)
            .build();
    ...
    void sendSickNoteConvertedToVacationNotification(Application application, long workDays) {
        ...
        final Mail mailToApplicant = Mail.builder()
            ...
            .withTemplate("sicknote_converted", _ -> Map.of(APPLICATION, application, "workDays", workDays))
        ...
        final Mail mailToManagement = Mail.builder()
            ...
            .withTemplate("sicknote_converted_to_management", _ -> Map.of(APPLICATION, application, "workDays", workDays))
            .build();
        mailService.send(mailToManagement);
    }
    ...
    void sendRemindNotificationToManagement(Application application, long workDays) {
        ...
        final MailTemplateModelSupplier modelSupplier = _ -> Map.of(APPLICATION, application, "workDays", workDays);
